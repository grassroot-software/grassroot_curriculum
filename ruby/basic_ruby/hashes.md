...
2. Complete the [hash](https://github.com/grassroot-software/ruby-exercises/tree/main/ruby_basics) exercises from the [ruby-exercises repo](https://github.com/grassroot-software/ruby-exercises) that you previously cloned.
</div>
