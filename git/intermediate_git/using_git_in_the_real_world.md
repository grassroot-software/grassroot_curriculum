...
6. You may have merge conflicts... resolve those using the skills you learned in [the Deeper Look at Git lesson](https://learn.grassroot.academy/lessons/ruby-a-deeper-look-at-git)! ([JS Course Link](https://learn.grassroot.academy/lessons/javascript-a-deeper-look-at-git))
