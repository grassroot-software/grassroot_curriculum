...
<div class="lesson-content__panel" markdown="1">
  ...
  2. Follow along with this [Simple Messaging App](https://github.com/grassroot-software/grassroot_curriculum/blob/main/ruby_on_rails/mailers_advanced_topics/actioncable_lesson.md) that we've written to give you a taste of introducing Action Cable to a project
</div>
