...
2. Build the new PostgreSQL Rails app `$ rails new grassroot-facebook --database=postgresql`, initialize the Git repo and update the README to link back to this page.
