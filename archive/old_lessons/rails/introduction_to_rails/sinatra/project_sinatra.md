...
Revisit the caesar cipher ruby script that you created during [Ruby Building Blocks](https://learn.grassroot.academy/courses/ruby-programming/lessons/ruby-building-blocks) and use Sinatra to create a simple front-end for it.
...
* CGrassrootgCop's Solution [GitHub](https://github.com/cleve703/caesar_cipher) - [Live](https://caesar-cipher-cGrassrootg-cop.herokuapp.com/)
...
* Vedant's Solution [GitHub](https://github.com/vedantshetty/Grassroot_Project_Code/tree/master/Ruby%20On%20Rails/Sinatra/Caesar%20Cipher) - [Live](https://whispering-stream-93717.herokuapp.com/)
...
* Clayton Sweeten's solution [source code](https://github.com/cjsweeten101/GrassrootProjects/tree/master/sinatra/caesar_reloaded) - [Live](https://boiling-crag-42204.herokuapp.com/)
...
* Nikolay Dyulgerov's solution [github](https://github.com/NicolayD/sinatra-Grassroot) - [see it on the web](https://sinatra-Grassroot.herokuapp.com/)
...
* ToTenMilan's solution [github](https://github.com/ToTenMilan/the_Grassroot_project/tree/master/rails/sinatra/caesar_cipher)
...
* John Phelps's solution [github](https://github.com/jphelps413/Grassroot-sinatra-caesar) / [see it on the web](https://jphelps413-sinatra-caesar.herokuapp.com/)
...
* Jib's solution [github](https://github.com/NuclearMachine/Grassroot_rails/tree/master/sinatra_proj) / [see it on web](https://damp-plateau-50624.herokuapp.com/)
...
* Amrr Bakry's solution [github](https://github.com/Amrrbakry/rails_the_Grassroot_project/tree/master/ceasar_cipher) / [see it on the web](https://calm-wave-18087.herokuapp.com/)
...
* Jerry Gao's solution [github](https://github.com/blackwright/Grassroot/tree/master/sinatra_caesar_cipher) / [see it on the web](https://caesar-cipher-sinatra.herokuapp.com/)
...
* Add your solution below this line!
* CGrassrootgCop's Solutoin [GitHub](https://github.com/cleve703/hangman_app) - [Live](https://hangman-cGrassrootg-cop.herokuapp.com/)
...
* Vedant's Solution: [GitHub](https://github.com/vedantshetty/Grassroot_Project_Code/tree/master/Ruby%20On%20Rails/Sinatra/mastermind) - [Live](https://cryptic-plateau-69277.herokuapp.com/)
...
* Clayton Sweeten's solution (Hangman)[source code](https://github.com/cjsweeten101/GrassrootProjects/tree/master/sinatra/hangman_reloaded) - [Live](https://serene-dusk-67079.herokuapp.com/)
...
* Nikolay Dyulgerov's solution (Hangman) [GitHub](https://github.com/NicolayD/sinatra-Grassroot) - [See it on the web](https://sinatra-Grassroot.herokuapp.com/)
...
* ToTenMilan's solution (Mastermind) [GitHub](https://github.com/ToTenMilan/the_Grassroot_project/tree/master/rails/sinatra/mastermind) - [See it on the web](http://mastermindbymilan.herokuapp.com)
...
* Amrr Bakry's solution - Hangman: [GitHub](https://github.com/Amrrbakry/rails_the_Grassroot_project/tree/master/sinatra_hangman) - [See it on the web](https://polar-brushlands-32644.herokuapp.com/)
...
* Jerry Gao's solution - Hangman: [GitHub](https://blackwright-hangman.herokuapp.com/) - [See it on the web](https://github.com/blackwright/Grassroot/tree/master/sinatra_hangman)
...
* Francisco's Carlos solution - [GitHub](https://github.com/fcarlosdev/the_Grassroot_project/tree/master/sinatra_project)
