...
<div class="lesson-content__panel" markdown="1">
  1. Read through the [Ruby in 100 Minutes](http://tutorials.jumpstartlab.com/projects/ruby_in_100_minutes.html) project from Jumpstart Lab.  If you can't get IRB running, check out the [Installations Section](https://www.grassroot.herokuapp.com/courses/foundations/lessons/your-first-rails-application?ref=lnav), which you should have done already.
