...
4. Have a look at The Grassroot Project's very [own repository on GitHub](https://github.com/grassroot-software/grassroot_curriculum) - this is where all the lessons are stored!
5. Finally, gain an appreciation of [how git records all collaborative efforts](https://github.com/grassroot-software/grassroot_curriculum/graphs/contributors) and how GitHub visually represents this.
