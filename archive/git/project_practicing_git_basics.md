...
1. You should have already created a GitHub account in the [Setting up Git](https://learn.grassroot.academy/paths/foundations/courses/foundations/lessons/setting-up-git) lesson. If you haven't done that yet, you can sign up [here](https://github.com/).
