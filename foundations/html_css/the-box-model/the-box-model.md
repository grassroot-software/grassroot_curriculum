...
![boxes](https://cdn.statically.io/gh/grassroot-software/grassroot_curriculum/main/foundations/html_css/the-box-model/imgs/boxes.png)

You can use the browser's inspector to add the CSS above to this web page if you want. Boxes in boxes!

![lines](https://cdn.statically.io/gh/grassroot-software/grassroot_curriculum/main/foundations/html_css/the-box-model/imgs/odin-lined.png)
...
![the box model](https://cdn.statically.io/gh/grassroot-software/grassroot_curriculum/main/foundations/html_css/the-box-model/imgs/box-model.png)
