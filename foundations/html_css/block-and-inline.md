...
4.  Go to our [CSS exercises repository](https://github.com/histo-ry/css-exercises) and do "01-margin-and-padding-1" and "02-margin-and-padding-2" in the `margin-and-padding` directory.
