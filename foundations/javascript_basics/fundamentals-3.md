...
Let's write some functions!  Write these in the `script` tag of a skeleton HTML file. If you've forgotten how to set it up, review the instructions from [Fundamentals Part 1](https://learn.grassroot.academy/lessons/foundations-fundamentals-part-1#how-to-run-javascript-code).
