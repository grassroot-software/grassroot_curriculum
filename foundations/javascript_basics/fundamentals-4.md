...
1. Set up the files and Jest by carefully following the directions in the [repository's README](https://github.com/grassroot-software/javascript-exercises#readme).
