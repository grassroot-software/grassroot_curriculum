...
1. Set up a GitHub Repo for this project. Follow the instructions in [Git basics](https://www.grassroot.herokuapp.com/paths/foundations/courses/foundations/lessons/git-basics) if you need help.
