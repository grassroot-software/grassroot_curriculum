...
1. Set up a GitHub Repo for this project. Follow the instructions in [Git basics](https://learn.grassroot.academy/lessons/foundations-git-basics) if you need help.
