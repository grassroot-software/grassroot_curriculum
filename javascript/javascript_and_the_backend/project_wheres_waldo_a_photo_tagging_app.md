...
1. Set up a GitHub Repo for this project. Follow the instructions atop the [Recipes project](https://learn.grassroot.academy/lessons/foundations-recipes) if you need help.
