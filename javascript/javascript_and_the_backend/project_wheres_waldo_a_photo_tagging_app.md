...
1. Set up a GitHub Repo for this project. Follow the instructions atop the [Recipes project](https://www.grassroot.herokuapp.com/lessons/foundations-recipes) if you need help.
