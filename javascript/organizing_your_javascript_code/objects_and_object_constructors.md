...
If you are feeling rusty on using objects, now might be a good time to go back and review the content in [__Fundamentals 5__](https://learn.grassroot.academy/lessons/foundations-fundamentals-part-5) from our JavaScript Basics course.
