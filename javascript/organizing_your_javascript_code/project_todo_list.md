...
- [CodeWars](https://www.codewars.com/) - A neat gamified system with leveled exercises.  As you complete more exercises you level up and access more difficult ones. To join the The Grassroot Project clan: go to your account settings on the codewars website and add "The Grassroot Project" in the `Clan` field. 
